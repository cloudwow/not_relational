...
module S3
  ...
  def S3.canonical_string(method, bucket="", path="", path_args={}, headers={}, expires=nil)
    ...
    headers.each do |key, value|
      ...
      if (lk == 'content-md5' or
        ...
        raise "HEADER WTF" unless value.is_a?(Array) && value.length==1
        
        interesting_headers[lk] = value[0].to_s.strip
      end
    end
  ...
  class AWSAuthConnection
    ...
    def initialize(aws_access_key_id, aws_secret_access_key, is_secure=false,
  ...
  class QueryStringAuthGenerator
    ...
    DEFAULT_EXPIRES_IN = 60  unless const_defined?("DEFAULT_EXPIRES_IN")
  ...
  module CallingFormat 
    unless const_defined?("SUBDOMAIN")
